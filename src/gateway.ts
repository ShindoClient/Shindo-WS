...
import { ClientToServer, ConnectionState } from "./types.js";
      ...
      try {
        ...
        switch (msg.type) {
          case "auth": {
            ...
            const accountType = msg.accountType || computeAccountType(roles);
...
const ROLE_ORDER = ["STAFF","DIAMOND","GOLD","MEMBER"];
function computeAccountType(roles: string[]): string {
